...
def load_data(dataset):
    ...
    #     import urllib
    #     #origin = 'http://www.iro.umontreal.ca/~loisa/deep/data/mnist/mnist.pkl.gz'
...
def sgd_optimization_mnist(
    ...
    mytrain_model = theano.function(inputs=[index],
            outputs=classifier.errors(y),
            givens={
    ...
    end_time = time.clock()
    print(('Optimization complete with:\n'
           'best train score of %f %%, '
           'best validation score of %f %%, '
           'with test performance %f %%') %
                 (best_train_loss * 100, best_validation_loss * 100., test_score * 100.))
